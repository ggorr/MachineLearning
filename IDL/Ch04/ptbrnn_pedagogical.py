...
def startRnn(epochs=10, saveResult=True):
	...
	with tf.Session() as sess:
		...
		info = {'style': 'rnn_ped', 'batch size': batchSz, 'embed size': embedSz, 'rnn size': rnnSz, 'win size': winSz,
...
if __name__ == '__main__':
	...
	# startRnn(epochs=1)
	runMoreRnn(epochs=1)
# cosSimTable(['under', 'above', 'the', 'a', 'recalls', 'says', 'rules', 'laws', 'computer', 'machine'], 'rnn_ped')
